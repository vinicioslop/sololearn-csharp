namespace DrawingApplication
{
    class Program
    {
        static void main(string[] args)
        {
            ...
            // only 1 tool - a pencil. You want to add brush and spray
            // to the drawing toolbar.
            // The program you are given declares an IDraw interface with
            // the StartDraw() method, and class Draw, which performs pencil
            // drawing by implementing the IDraw interface. It outputs
            // "Using pencil".
            // Complete the given Brush and Spray classes by
            // - inheriting them from class Draw
            // - implementing the StartDraw() method for each tool, in order
            // to output
