...
namespace SocialNetwork
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // As a user creates a post, the text "New post" should be
            // automatically outputted so that then the user can add the text
            // he/she wants to share.
            // The program you are given declares a Post class with a text
            // private field, and the ShowPost() method which outputs the content.
            // Complete the class with
            // - a constructor, which outputs "New post" as called,
            // - Text property, which will allow you to get and set the value of
            // the text field.
